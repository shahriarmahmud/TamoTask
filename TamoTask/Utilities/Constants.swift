...
struct Constants {
    static let ttToken = "ttToken"
    static let ttUserID = "ttUserID"
    static let ttFName = "ttFName"
    static let ttLName = "ttLName"
    ...
    static let defaultUserFName = "Test"
    static let defaultUserLName = "User"
